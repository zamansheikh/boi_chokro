              ...
              children: [
                ...
                Row(
                  children: [
                    if (product.availability == "Paid")
                    ...
                    else if (product.exchangeNeeds != null)
                      Expanded(
                        child: Text(
                          "Needs: ${product.exchangeNeeds}",
                          style: const TextStyle(
                            fontSize: 10,
                            color: Colors.grey,
                          ),
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.w600,
                          color: product.availability == "Free"
                              ? Colors.green
                              : Colors.blue,
                        ),
                      ),
...
class Product {
  ...
  final String availability; // Free, Paid, or Exchange
  final String distance; // Distance from user to seller/gifter
  final String? exchangeNeeds; // Items needed for exchange (optional)
...
List<Product> demoProducts = [
  Product(
    ...
    images: [
      "https://th.bing.com/th/id/R.f57a6eb4fdc3b5ff97e3ba1d33ea1802?rik=lh3xhm55V2FV9w&pid=ImgRaw&r=0"
    ],
    availability: "Free",
  ...
  Product(
    id: 2,
    title: "Atomic Habits",
    description: "An insightful guide to building good habits by James Clear.",
    images: [
  ...
  Product(
    ...
    exchangeNeeds: "Brave New World by Aldous Huxley",
    rating: 4.7,
    isFavourite: false,
  ),
  Product(
  ...
  Product(
    ...
    exchangeNeeds: "Any contemporary fiction book",
    rating: 4.8,
    isFavourite: true,
  ),
];
